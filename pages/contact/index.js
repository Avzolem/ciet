...
const ContactPage = () => {
    ...
    return (
        <div className="flex min-h-screen  bg-gradient-to-r from-black to-black py-16 px-4 sm:px-6 lg:px-8 lg:py-24">
            {/* PUNTITOS */}
                    ...
                    <form onSubmit={handleSubmit(onSubmit)} className="">
                        ...
                        <div className="w-full">
                            <div className="flex">
                                ...
                                <a
                                    ...
                                    className="block text-sm font-medium text-purple-300 hover:text-blue-200"
                                >
                                    {" "}
                                    &nbsp; Aviso de Privacidad
                                </a>
                        ...
                        <div className="sm:col-span-2">
                            <div className="relative group">
                                ...
                                r opacity-75 group-hover:opacity-100 transition duration-1000 group-hover:duration-200"
                                ></div>
                                <button
                                    type="submit"
