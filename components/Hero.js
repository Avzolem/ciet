				...
				<nav
					...
					<div className="flex lg:flex-1">
						<a href="#" className="-m-1.5 p-1.5">
							...
							<img className="h-8 w-auto" src="/images/+uach.png" alt="" />
						</a>
					</div>
					...
					<div className="hidden lg:flex lg:flex-1 lg:justify-end">
						<a href="#" className="text-sm font-semibold leading-6 text-white">
							UACH <span aria-hidden="true">&rarr;</span>
						</a>
					</div>
				</nav>
				<Dialog
					...
					<Dialog.Panel className="fixed inset-y-0 right-0 z-50 w-full overflow-y-auto bg-gray-900 px-6 py-6 sm:max-w-sm sm:ring-1 sm:ring-white/10">
						<div className="flex items-center justify-between">
							<a href="#" className="-m-1.5 p-1.5">
								<span className="sr-only">Your Company</span>
								<img className="h-8 w-auto" src="+uach.png" alt="+ uach" />
							</a>
							<button
								type="button"
				...
				<div className="mx-auto max-w-2xl py-32 sm:py-48 lg:py-56">
					...
					<div className="text-center">
						...
						<p className="mt-6 text-lg leading-8 text-gray-300">
							Brindamos productos servicios y soluciones, para la transformación
						...
						<div className="mt-10 flex items-center justify-center gap-x-6">
							...
							<a
								href="#"
								className="text-sm font-semibold leading-6 text-white">
								Portafolio de soluciones <span aria-hidden="true">→</span>
							</a>
						</div>
					</div>
				</div>
